  ...
  if (session) {
    ...
    return (
      <div className="flex items-center gap-3">
        ...
        <span className="hidden text-sm text-gray-600 sm:block">{name}</span>
        <button
          onClick={signOut}
          className="rounded-full border border-gray-200 bg-white px-3 py-1.5 text-xs font-medium text-gray-600 shadow-sm transition hover:bg-gray-50"
        >
          Déconnexion
        </button>
      </div>
